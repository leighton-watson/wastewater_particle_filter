function [R,RHO,I,WW,L,TIME,T,ESS] = covidParticleFilter(P,CASEDATA,WWDATA,R,RHO,I,WW,L)
% function [R,RHO,I,WW,out] = covidParticleFilter(P,cases,ww,R,RHO,I,WW);
...
for tt = P.tIn + 1 : P.TMAX
    ...
    WW(:,tt) = sum(dailyShedding,2)/P.POP; % genome copies
...
T = 1:tt;
TIME = datetime(T*24*3600,'ConvertFrom','epochtime','Epoch',P.START_DATE);
